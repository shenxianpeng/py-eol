...
def test_sync_data_success(monkeypatch):
	...
	monkeypatch.setattr(sync_data_mod, "fetch_py_eol_data", lambda: [{"cycle": "3.99", "eol": "2099-01-01"}])
	monkeypatch.setattr(sync_data_mod, "generate_eol_data_content", lambda data: "test content")
